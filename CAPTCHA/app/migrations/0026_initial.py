...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0025_remove_partition_partition_id_delete_images_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.CharField(blank=True, max_length=1000001, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Partition',
            fields=[
                ...
                ('image_partition', models.CharField(blank=True, max_length=100000, null=True)),
